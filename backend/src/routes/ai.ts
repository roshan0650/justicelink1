 ...
 */
router.post('/legal-summary', protect, async (req: Request, res: Response): Promise<void> => {
  try {
 ...
 */
router.post('/legal-advice', protect, async (req: Request, res: Response): Promise<void> => {
  try {
    const { problemDescription } = req.body;
 ...
 */
router.post('/identify-laws', protect, async (req: Request, res: Response): Promise<void> => {
  try {
    const { problemDescription } = req.body;
 ...
 */
router.post('/document-template', protect, async (req: Request, res: Response): Promise<void> => {
  try {
